...
class FtxClient:
    ...
    def list_markets_history(self, market, resolution, limit, start_time, end_time) -> List[dict]:
    ...
    def get_funding_payment(self, start, end) -> List[dict]:
        return self._get('funding_payments', {'start_time': start, 'end_time': end})

    def get_trading_fee(self, market):
        return self._get(f'fills?market={market}', {'start': 1617235200, 'limit':5000})
    ...
    def submit_lending_offer(self, coin: str, size: float, rate: float) -> dict:
